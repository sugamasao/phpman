<?php
\local\test\db\UniqueCodeDigit::create_table();
\local\test\db\UniqueCodeDigit::find_delete();


$obj = new \local\test\db\UniqueCodeDigit();
eq(null,$obj->code1());
eq(null,$obj->code2());
eq(null,$obj->code3());
$obj->save();

foreach(\local\test\db\UniqueCodeDigit::find() as $o){
	neq(null,$o->code1());
	neq(null,$o->code2());
	neq(null,$o->code3());
